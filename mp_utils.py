...
def heuristic_2opt_bi(positions, procnum, return_dict):
    """
    Improves an existing route using 2-opt until no improvement is found
...
def heuristic_2opt_fi_restart(positions, steps, procnum, return_dict):
    """
    Improves an existing route using 2-opt until no improvement is found
...
def heuristic_2opt_bi_restart(positions, steps, procnum, return_dict):
    """
    Improves an existing route using 2-opt until no improvement is found
